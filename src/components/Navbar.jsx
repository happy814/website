...
// Update the hrefs to match the routes in your Astro project
const navLinks = [
  { name: "Home", href: "/" },
  { name: "Services", href: "/service" },
  { name: "Merch Store", href: "/Merch-Store" },
...
function Navbar() {
  ...
  return (
    <nav className="select-none px-3 lg:px-10 py-5 relative bg-[#151217] border-b-2 border-white">
      <div className="w-full flex justify-between items-center mx-auto">
        ...
        <div className="hidden uppercase md:flex space-x-8 md:pl-16 lg:pl-40">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
